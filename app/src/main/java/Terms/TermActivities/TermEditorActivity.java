...
public class TermEditorActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        termNameField = (EditText) findViewById(R.id.termNameField);
        termStartDateField = (EditText) findViewById(R.id.termStartField);
        termStartDateField.setInputType(InputType.TYPE_NULL);
        termEndDateField = (EditText) findViewById(R.id.termEndField);
